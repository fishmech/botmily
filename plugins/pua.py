...
import random
#randomly return one of the last 200 tweets from https://twitter.com/PUA_txt
#rate limit is 300 requests per 15 minutes
def puatxt(message_data, bot):
    ...
    tweet = t.statuses.user_timeline.PUA_txt(count=200)[tweetno]
    return tweet['text']


commands = {"puatxt": puatxt}
triggers = []
