...
import random
#randomly return one of the last 200 tweets from https://twitter.com/nanowrimo_txt
#rate limit is 300 requests per 15 minutes
def nanowrimo(message_data, bot):
    ...
    tweet = t.statuses.user_timeline.nanowrimo_txt(count=200)[tweetno]
    return tweet['text']


commands = {"nanowrimo": nanowrimo}
triggers = []
