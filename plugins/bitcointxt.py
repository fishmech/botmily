...
import random
#randomly return one of the last 200 tweets from https://twitter.com/bitcoin_txt
#rate limit is 300 requests per 15 minutes
def bitcoin(message_data, bot):
    ...
    tweet = t.statuses.user_timeline.bitcoin_txt(count=200)[tweetno]
    return tweet['text']


commands = {"bitcoin": bitcoin}
triggers = []
