...
import random
#randomly return one of the last 200 tweets from https://twitter.com/PUAHate_txt
#rate limit is 300 requests per 15 minutes
def puahate(message_data, bot):
    ...
    tweet = t.statuses.user_timeline.PUAHate_txt(count=200)[tweetno]
    return tweet['text']


commands = {"puahate": puahate}
triggers = []
