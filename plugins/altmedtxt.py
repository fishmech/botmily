...
import random
#randomly return one of the last 200 tweets from https://twitter.com/altmed_txt
#rate limit is 300 requests per 15 minutes
def altmed(message_data, bot):
    ...
    tweet = t.statuses.user_timeline.altmed_txt(count=200)[tweetno]
    return tweet['text']


commands = {"altmed": altmed}
triggers = []
